...
namespace SKit.Email.MailKit
{
    ...
    public class SmtpService : ISmtpService
    {
        ...
        private readonly MailMessage _defaultMessage;
            ...
            )
        {
            ...
            _options = settings.SmtpSettings;
            _defaultMessage = settings.DefaultMessage;
            _logger = logger;
            this.S = S;
        }
        ...
        public MailMessage CreateDefaultMessage()
        {
            return new MailMessage {
                From = _defaultMessage.From,
                To = _defaultMessage.To,
                Cc = _defaultMessage.Cc,
                Bcc = _defaultMessage.Bcc,
                ReplyTo = _defaultMessage.ReplyTo,
                Subject = _defaultMessage.Subject,
                //Body = _defaultMessage.Body,
                IsBodyHtml = _defaultMessage.IsBodyHtml
            };
        }
    }
}
